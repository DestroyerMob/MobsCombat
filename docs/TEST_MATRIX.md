...
| Aggression indicator | Let an unaware mob acquire you, then repeat while hidden outside its awareness cone and while another player is targeted. | The supplied alert icon briefly appears above the mob only for the player it successfully targets; canceled target changes do not show it. |
